...
export default function TeacherForm() {
    ...
    return (
        <div className="container" id="page-teacher-form">
            <PageHeader title="Que incrível que você quer dar aulas" description="O primeiro passo é preencher esse formulario de inscrição."/>
            ...
            <fieldset>
                <legend>
                    ...
                    <button type="button"
                        onClick={addNewScheduleItem}>+ Novo Horario</button>
                </legend>
